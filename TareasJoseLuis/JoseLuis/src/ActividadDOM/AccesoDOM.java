...
//voy a crear todo sobre titulo
            Node ntitulo = doc.createElement("Titulo"); //creo el nodo titulo
            Node ntitulo_text = doc.createTextNode(titulo); //creo para guardar el titulo en el nodo titulo
            ntitulo.appendChild(ntitulo_text);//añade el titulo

//voy a crear todo sobre autor
